...
| M4  | Quotes: builder with live breakdown, save as snapshot, accept (immutable), list; Home with action banner, recent drafts and quick duty check                                                                                                | M3                                    | none expected               | In progress |
